    ...
    <View className={`flex-1 ${dark ? 'bg-zinc-950' : 'bg-[#F8FAFC]'}`}>
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }} bounces={false} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <Text className="text-white/80 text-sm mt-1 font-medium">Suivez vos signalements</Text>
        </View>
        ...
        <View className="px-5">
          <View className={`rounded-[24px] px-6 py-5 flex-row justify-between shadow-xl ${dark ? 'bg-zinc-900 border border-zinc-800' : 'bg-white border border-gray-100'}`}
            ...
            <View className="items-center">
              <Text className="text-3xl font-bold" style={{ color: primaryColor }}>1</Text>
        ...
        <View className="px-5 mt-8">
          ...
          <TouchableOpacity className={`rounded-[20px] p-5 mb-4 shadow-sm border ${dark ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-gray-100'}`}>
            ...
            <View className="flex-row justify-between items-center">
              ...
              <View className="px-3 py-1 rounded-full flex-row items-center" style={{ backgroundColor: `${primaryColor}15` }}>
                <View className="w-1.5 h-1.5 rounded-full mr-1.5" style={{ backgroundColor: primaryColor }} />
                <Text className="text-xs font-semibold" style={{ color: primaryColor }}>En cours</Text>
              </View>
            </View>
          </TouchableOpacity>
